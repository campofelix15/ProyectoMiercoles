...
public class PlayerMovement : MonoBehaviour
{
    ...
    private bool warnedMissingLeftBorder;
    ...
    private void Start()
    {
        if (leftBorder == null)
        {
            GameObject lb = GameObject.Find("LeftBorder");
            if (lb != null) leftBorder = lb.transform;
        }
    }
                                                                                                            //Monobehauvior
    ...
    void LimitLeft()
    {
        if (leftBorder == null)
        {
            if (!warnedMissingLeftBorder)
            {
                warnedMissingLeftBorder = true;
                Debug.LogWarning("[PlayerMovement] leftBorder no asignado. No se aplicará el límite izquierdo hasta que exista un objeto 'LeftBorder' o se asigne por inspector.");
            }
            return;
        }
